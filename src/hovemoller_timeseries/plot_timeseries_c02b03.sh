...
id=c02b03
simulations=(
    "exp03_ens_20161231" "run01_ctl-run02_fixedSST" "2016-12-31" "2016-12-31" "2017-01-10" 27 33 202 208 "0-9" do
    "exp03_ens_20161231" "run01_ctl-run02_fixedSST" "2016-12-31" "2016-12-31" "2017-01-10" 35 40 230 235 "0-9" do
)
    
#"exp03_ens_20161231" "run01_ctl-run05_som-run02_fixedSST-run06_hidiff" "2016-12-31" "2016-12-31" "2017-01-10" 35 40 230 235 "0-9" do
 
    #"exp03_ens_20161231" "run01_ctl-run03_noadv-run05_som-run02_fixedSST-run04_hivisc-run06_hidiff" "2016-12-31" "2016-12-31" "2017-01-10" 35 40 230 235 "0" do
#simulations=(
#    "exp03_ens_20161231" "run01_ctl-run05_som-run06_hidiff" "2016-12-31" "2016-12-31" "2017-01-07" 35 40 230 235 "0" do
#)
    

#    "exp03_ens_20161231" "run03_noadv-run05_som" "2016-12-31" "2016-12-31" "2017-01-07" 35 37 230 232 "0" do
#"exp03_ens_20161231" "run01_ctl-run03_noadv-run05_som-run02_fixedSST-run04_hivisc" "2016-12-31" "2016-12-31" "2017-01-11" 20 50 230 244 "0-9" do

#    "exp03_ens_20161231" "run01_ctl-run03_noadv-run05_som-run02_fixedSST-run04_hivisc" "2016-12-31" "2016-12-31" "2017-01-14" 20 52 180 244 "0-9"
#    "exp03_ens_20161231" "run01_ctl-run03_noadv-run05_som-run02_fixedSST-run04_hivisc" "2016-12-31" "2016-12-31" "2017-01-14" 20 52 180 244 "0-9"

#simulations=(
#    "exp03_ens_20161231" "run01_ctl-run02_fixedSST" "2016-12-31" "2016-12-31" "2017-01-01" 35 40 230 235 "0-1" do
#)
